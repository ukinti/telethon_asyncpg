...
from telethon.tl.core import RpcResult, MessageContainer, GzipPacked
    ...
    async def _try_gen_auth_key(self, attempt):
        ...
        try:
            ...
            if self._auth_key_callback:
                __auth_key_setter = self._auth_key_callback(self.auth_key)
                if inspect.isawaitable(__auth_key_setter):
                    await __auth_key_setter
